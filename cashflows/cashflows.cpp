...
namespace QuantLib 
{
    ...
    /*static*/ Date CashFlows::startDate(const Leg& leg) 
    {
    ...
    /*static*/ Date CashFlows::maturityDate(const Leg& leg) 
    {
        QL_REQUIRE(!leg.empty(), "empty leg");
    ...
    /*static*/ bool CashFlows::isExpired(const Leg& leg,
    ...
    /*static*/ Date CashFlows::previousCashFlowDate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
    ...
    /*static*/ Date CashFlows::nextCashFlowDate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
    ...
    /*static*/ Real CashFlows::previousCashFlowAmount(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_reverse_iterator cf;
    ...
    /*static*/ Real CashFlows::nextCashFlowAmount(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf;
    ...
    /*static*/ Rate CashFlows::previousCouponRate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_reverse_iterator cf;
    ...
    /*static*/ Rate CashFlows::nextCouponRate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf;
    ...
    /*static*/ Real CashFlows::nominal(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
    ...
    /*static*/ Date CashFlows::accrualStartDate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Date CashFlows::accrualEndDate(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Date CashFlows::referencePeriodStart(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Date CashFlows::referencePeriodEnd(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Time CashFlows::accrualPeriod(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Date::serial_type CashFlows::accrualDays(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        Leg::const_iterator cf = nextCashFlow(leg,
    ...
    /*static*/ Time CashFlows::accruedPeriod(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        if (settlementDate == Date())
    ...
    /*static*/ Date::serial_type CashFlows::accruedDays(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        if (settlementDate == Date())
    ...
    /*static*/ Real CashFlows::accruedAmount(const Leg& leg,
    bool includeSettlementDateFlows,
    Date settlementDate) 
    {
        if (settlementDate == Date())
    ...
    /*static*/ /*static*/ /*static*/ /*static*/ Real CashFlows::npv(const Leg& leg,
    ...
    /*static*/ /*static*/ /*static*/ Real CashFlows::bps(const Leg& leg,
    const YieldTermStructure& discountCurve,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate) 
    ...
    /*static*/ void CashFlows::npvbps(const Leg& leg,
    const YieldTermStructure& discountCurve,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate,
    ...
    /*static*/ Rate CashFlows::atmRate(const Leg& leg,
    const YieldTermStructure& discountCurve,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate,
    ...
    /*static*/ Rate CashFlows::yield(const Leg& leg,
    Real npv,
    const DayCounter& dayCounter,
    ...
    /*static*/ /*static*/ Time CashFlows::duration(const Leg& leg,
    ...
    /*static*/ /*static*/ Real CashFlows::convexity(const Leg& leg,
    const InterestRate& y,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate) 
    ...
    /*static*/ /*static*/ Real CashFlows::basisPointValue(const Leg& leg,
    const InterestRate& y,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate) 
    ...
    /*static*/ /*static*/ Real CashFlows::yieldValueBasisPoint(const Leg& leg,
    const InterestRate& y,
    bool includeSettlementDateFlows,
    Date settlementDate,
    Date npvDate) 
    ...
    /*static*/ Spread CashFlows::zSpread(const Leg& leg,
    Real npv,

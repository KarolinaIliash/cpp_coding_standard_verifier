...
namespace QuantLib 
{
    ...
    /*virtual*/ void CPICoupon::accept(AcyclicVisitor& v) 
    {
    ...
    /*virtual*/ Date CPICashFlow::baseDate() const 
    {
        // you may not have a valid date
        QL_FAIL("no base date specified");
    }

    /*virtual*/ Real CPICashFlow::baseFixing() const 
    {
        return baseFixing_;
    }

    /*virtual*/ Real CPICashFlow::amount() const 
    {
        Real I0 = baseFixing();
        Real I1;
    ...
    CPILeg::operator Leg() const 
    {
        ...
        if (n>0) 
        {
            ...
            for (Size i=0; i<n; ++i) 
            {
                ...
                if (detail::get(fixedRates_, i, 1.0) == 0.0) 
                {
                    // fixed coupon

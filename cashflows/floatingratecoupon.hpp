...
namespace QuantLib 
{
    ...
    /*virtual*/ inline Rate FloatingRateCoupon::convexityAdjustment() const 
    {
        return convexityAdjustmentImpl(indexFixing());
    }

    /*virtual*/ inline Rate FloatingRateCoupon::adjustedFixing() const 
    {
    ...
    /*virtual*/ inline void FloatingRateCoupon::accept(AcyclicVisitor& v) 
    {

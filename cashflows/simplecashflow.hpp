...
namespace QuantLib 
{
    ...
    */
    ...
    /*virtual*/ inline void SimpleCashFlow::accept(AcyclicVisitor& v) 
    {
    ...
    /*virtual*/ inline void Redemption::accept(AcyclicVisitor& v) 
    {
    ...
    /*virtual*/ inline void AmortizingPayment::accept(AcyclicVisitor& v) 
    {

...
namespace QuantLib 
{
    ...
    /*virtual*/ void YoYInflationCouponPricer::setCapletVolatility(
    ...
    /*virtual*/ Real YoYInflationCouponPricer::floorletPrice(Rate effectiveFloor) const
    {
        Real floorletPrice = optionletPrice(Option::Put, effectiveFloor);
        return gearing_ * floorletPrice;
    }

    /*virtual*/ Real YoYInflationCouponPricer::capletPrice(Rate effectiveCap) const
    {
    ...
    /*virtual*/ Rate YoYInflationCouponPricer::floorletRate(Rate effectiveFloor) const
    {
        return floorletPrice(effectiveFloor)/
        (coupon_->accrualPeriod()*discount_);
    }

    /*virtual*/ Rate YoYInflationCouponPricer::capletRate(Rate effectiveCap) const
    {
        return capletPrice(effectiveCap)/(coupon_->accrualPeriod()*discount_);
    }


    /*virtual*/ Real YoYInflationCouponPricer::optionletPriceImp(
    ...
    /*virtual*/ Real YoYInflationCouponPricer::optionletPrice(Option::Type optionType,
    ...
    /*virtual*/ Rate YoYInflationCouponPricer::adjustedFixing(Rate fixing) const 
    {
    ...
    /*virtual*/ void YoYInflationCouponPricer::initialize(const InflationCoupon& coupon) 
    {
    ...
    /*virtual*/ Real YoYInflationCouponPricer::swapletPrice() const 
    {
    ...
    /*virtual*/ Rate YoYInflationCouponPricer::swapletRate() const 
    {

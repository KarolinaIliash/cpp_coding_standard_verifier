...
namespace QuantLib 
{
    ...
    /*virtual*/ void RangeAccrualFloatersCoupon::accept(AcyclicVisitor& v) 
    {
    ...
    /*virtual*/ Real RangeAccrualPricer::swapletRate() const 
    {
        return swapletPrice()/(accrualFactor_*discount_);
    }

    /*virtual*/ Real RangeAccrualPricer::capletPrice(Rate) const 
    {
        QL_FAIL("RangeAccrualPricer::capletPrice not implemented");
    }

    /*virtual*/ Rate RangeAccrualPricer::capletRate(Rate) const 
    {
        QL_FAIL("RangeAccrualPricer::capletRate not implemented");
    }

    /*virtual*/ Real RangeAccrualPricer::floorletPrice(Rate) const 
    {
        QL_FAIL("RangeAccrualPricer::floorletPrice not implemented");
    }

    /*virtual*/ Rate RangeAccrualPricer::floorletRate(Rate) const 
    {
    ...
    /*virtual*/ Real RangeAccrualPricerByBgm::swapletPrice() const
    {
    ...
    Real correlation) const
    {
        ...
        if(startTime_ > 0)
        {
            result = driftBeforeFixing;
        }
        else 
        {
            result = driftAfterFixing;
        }

...
namespace QuantLib 
{
    ...
    Real LinearTsrPricer::meanReversion() const 
    {
        return meanReversion_->value(); 
    }

    /*virtual*/ Rate LinearTsrPricer::swapletRate() const 
    {
        return swapletPrice() /
        (coupon_->accrualPeriod() *
    ...
    /*virtual*/ Real LinearTsrPricer::capletPrice(Rate effectiveCap) const 
    {
    ...
    /*virtual*/ Rate LinearTsrPricer::capletRate(Rate effectiveCap) const 
    {
    ...
    /*virtual*/ Real LinearTsrPricer::floorletPrice(Rate effectiveFloor) const 
    {
    ...
    /*virtual*/ Rate LinearTsrPricer::floorletRate(Rate effectiveFloor) const 
    {
    ...
    /*virtual*/ Real LinearTsrPricer::swapletPrice() const 
    {
        if (fixingDate_ <= today_) 
        {
            // the fixing is determined

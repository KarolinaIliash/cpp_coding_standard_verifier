...
namespace QuantLib 
{
    ...
    Real HaganPricer::meanReversion() const 
    {
        return meanReversion_->value();
    }

    /*virtual*/ Rate HaganPricer::swapletRate() const 
    {
        return swapletPrice()/(coupon_->accrualPeriod()*discount_);
    }

    /*virtual*/ Real HaganPricer::capletPrice(Rate effectiveCap) const 
    {
    ...
    /*virtual*/ Rate HaganPricer::capletRate(Rate effectiveCap) const 
    {
        return capletPrice(effectiveCap)/(coupon_->accrualPeriod()*discount_);
    }

    /*virtual*/ Real HaganPricer::floorletPrice(Rate effectiveFloor) const 
    {
    ...
    /*virtual*/ Rate HaganPricer::floorletRate(Rate effectiveFloor) const 
    {
    ...
    /*virtual*/ Real NumericHaganPricer::optionletPrice(
    ...
    /*virtual*/ Real NumericHaganPricer::swapletPrice() const 
    {
    ...
    /*static*/ ext::shared_ptr<GFunction> GFunctionFactory::newGFunctionStandard(Size q,
    ...
    /*static*/ ext::shared_ptr<GFunction> GFunctionFactory::newGFunctionExactYield(const CmsCoupon& coupon) 
    {
    ...
    /*static*/ ext::shared_ptr<GFunction> GFunctionFactory::newGFunctionWithShifts(const CmsCoupon& coupon,
    const Handle<Quote>& meanReversion) 
    {

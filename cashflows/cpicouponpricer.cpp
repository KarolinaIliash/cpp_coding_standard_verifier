...
namespace QuantLib 
{
    ...
    /*virtual*/ void CPICouponPricer::setCapletVolatility(
    ...
    /*virtual*/ Real CPICouponPricer::floorletPrice(Rate effectiveFloor) const
    {
        Real floorletPrice = optionletPrice(Option::Put, effectiveFloor);
        return gearing_ * floorletPrice;
    }

    /*virtual*/ Real CPICouponPricer::capletPrice(Rate effectiveCap) const
    {
    ...
    /*virtual*/ Rate CPICouponPricer::floorletRate(Rate effectiveFloor) const
    {
        return floorletPrice(effectiveFloor)/
        (coupon_->accrualPeriod()*discount_);
    }

    /*virtual*/ Rate CPICouponPricer::capletRate(Rate effectiveCap) const
    {
        return capletPrice(effectiveCap)/(coupon_->accrualPeriod()*discount_);
    }


    /*virtual*/ Real CPICouponPricer::optionletPriceImp(Option::Type,
    Real,
    Real,
    Real) const 
    {
    ...
    /*virtual*/ Real CPICouponPricer::optionletPrice(Option::Type optionType,
    ...
    /*virtual*/ Rate CPICouponPricer::adjustedFixing(Rate fixing) const 
    {
    ...
    /*virtual*/ void CPICouponPricer::initialize(const InflationCoupon& coupon) 
    {
    ...
    /*virtual*/ Real CPICouponPricer::swapletPrice() const 
    {
    ...
    /*virtual*/ Rate CPICouponPricer::swapletRate() const 
    {
